...
namespace vanmoofcraftymoltin\craftymoltin\assetbundles\indexcpsection;
...
class IndexCPSectionAsset extends AssetBundle
{
    ...
    public function init()
    {
        ...
        $this->sourcePath = "@vanmoofcraftymoltin/craftymoltin/assetbundles/indexcpsection/dist";
