...
namespace vanmoofcraftymoltin\craftymoltin\widgets;

use vanmoofcraftymoltin\craftymoltin\CraftyMoltin;
use vanmoofcraftymoltin\craftymoltin\assetbundles\craftymoltinwidgetwidget\CraftyMoltinWidgetWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * Crafty Moltin Widget
 *
 ...
 * @since     1.0.0
 */
class CraftyMoltinWidget extends Widget
{
    ...
    {
        return Craft::t('crafty-moltin', 'CraftyMoltinWidget');
    }
    ...
    {
        return Craft::getAlias("@vanmoofcraftymoltin/craftymoltin/assetbundles/craftymoltinwidgetwidget/dist/img/CraftyMoltinWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'crafty-moltin/_components/widgets/CraftyMoltinWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(CraftyMoltinWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'crafty-moltin/_components/widgets/CraftyMoltinWidget_body',
            [
