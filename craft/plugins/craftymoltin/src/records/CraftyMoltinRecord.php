...
namespace vanmoofcraftymoltin\craftymoltin\records;
 ...
 * @since     1.0.0
 */
class CraftyMoltinRecord extends ActiveRecord
{
    ...
    {
        return '{{%craftymoltin_craftymoltinrecord}}';
    }
}
